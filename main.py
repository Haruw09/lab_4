...
def fence(x, y, width, height):
    ...
    :param x: абцисса верхнего левого угла забора
    :param y: ордината верхнего левого угла забора
    :param width: длина забора
    :param height: высота забора
    :return:
    """
...
def chain(x, y, size, length):
    ...
    :param x: абцисса первого звена
    :param y: ордината первого звена
    :param size: размер звеньев
    :param length: количество звеньев
    :return:
    """
    X = x
    Y = y
...
def dog(x, y, size):
    ...
    :param x: абцисса правого уха собаки
    :param y: ордината правого уха собаки
    :param size: размер
    :return:
    """
    ...
    polygon(screen, white,
            [(x + 55 * size, y - 10 * size), (x + 56 * size, y - 12 * size), (x + 57 * size, y - 10 * size)])
    polygon(screen, white,
            [(x + 63 * size, y - 10 * size), (x + 64 * size, y - 12 * size), (x + 65 * size, y - 10 * size)])
